prompt1 = """Instruction: You are also an advanced reasoning agent that can improve based on previous experience. Follow the instruct and purchase an item meeting all of the correct specifications by navigating the website. 
